...
/*
 *  chilledDisplay
 *      DisplayTile for meat/seafood chilled counters
 */
public class chilledDisplay extends displayTile {

    private ArrayList<Product> products;   // up to 3

    public chilledDisplay(int posX, int posY, int floor, displayAddress address) {
        super(posX, posY, floor, address, "Chilled Counter", 3);
        loadSprite("assets/chilled.png");   // adjust filename if needed
    ...
    public void onInteract(Player player, Board board) {
        ...
        System.out.println("Interacted with chilled counter at " + getPosX() + ", " + getPosY());

        final JFrame frame = new JFrame("Chilled Counter");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        JPanel mainPanel = new JPanel();
        mainPanel.setLayout(new BorderLayout(10, 10));
        mainPanel.setBackground(new Color(220, 220, 220));
        mainPanel.setPreferredSize(new Dimension(490, 220));
        mainPanel.setBorder(BorderFactory.createEmptyBorder(20, 20, 20 ,20));

        JLabel mainTitle = new JLabel("Chilled Counter (" + address + ")", JLabel.CENTER);
        mainTitle.setFont(new Font("Leto", Font.BOLD, 20));
        mainPanel.add(mainTitle, BorderLayout.NORTH);

        // Chilled counter: 1 x 3
        ...
        productPanel.setPreferredSize(new Dimension(300, 120));
                ...
                productButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (toReturn == null) {
                            JOptionPane.showMessageDialog(
                                frame,
                                "You have no items that can be placed on this chilled counter.",
                                "Return Product",
                        ...
                        System.out.println("DEBUG: " + player.getName()
                                ...
                                + " (" + toReturn.getSerialID() + ") to chilled counter at "
                                + getPosX() + ", " + getPosY());
                    }
                });
            }
